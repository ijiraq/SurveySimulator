...
!             described in detos1 (128*R8)
! see ioutils.filter_to_index subroutine for code to convert from filter
! letter to color array index and parameters has a filter array that lists
! the expected order of the filters in non-ecsv headers
!                color(39) : g-x
!                color(50) : r-x
!                color(41) : i-x
!                color(58) : z-x
